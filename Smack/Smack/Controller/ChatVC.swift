...
//        }
        ...
        MessageService.instance.findAllChannel { (success) in
            if success{
                if MessageService.instance.channels.count > 0{
                    ...
                    self.channelNameLbl.text = "No channles yet!"
                }
            }
        }
    }
    ...
    @IBAction func sendMessagePressed(_ sender: Any) {
        if AuthService.instance.isLoggedIn{
            ...
            SocketService.instance.addMessage(messageBody: message, userId: UserDataService.instance.id, channelId: channelId, complition: { (success) in
                if success{
